(function (global, factory) {
    ...
    (factory((global['ngrx-data'] = {}),global.tslib,global.ng.core,global.Rx.Observable.prototype,global.ng.common.http,global.rxjs,global.ngrx.entity,global.ngrx.store,global.ngrx.effects));
     ...
     */
    var EntityActionFactory = (function () {
     ...
     */ EntityActionGuard = (function () {
         ...
         */
            function (action) {
                ...
                data.forEach(function (entity$$1, i) {
                    /** @type {?} */
                    var id = _this.selectId(entity$$1);
     ...
     * @return {?}
     */
    function defaultSelectId(entity$$1) {
        return entity$$1 == null ? undefined : entity$$1.id;
    }
    /**
    ...
    function toUpdateFactory(selectId) {
        ...
        /**
           ...
           */
        return function toUpdate(entity$$1) {
            /** @type {?} */
            var id = selectId(entity$$1);
            if (id == null) {
                throw new Error('Primary key may not be null/undefined.');
            }
            return entity$$1 && { id: id, changes: entity$$1 };
        };
    }
    ...
    function ofEntityOp() {
        ...
        switch (ops.length) {
            case 0:
                return operators.filter(function (action) { return action.payload && action.payload.entityOp != null; });
            case 1:
                /** @type {?} */
                var op_1 = ops[0];
                return operators.filter(function (action) { return action.payload && op_1 === action.payload.entityOp; });
            default:
    ...
    function ofEntityType() {
        ...
        switch (names.length) {
            case 0:
                return operators.filter(function (action) { return action.payload && action.payload.entityName != null; });
            case 1:
                /** @type {?} */
                var name_1 = names[0];
                return operators.filter(function (action) { return action.payload && name_1 === action.payload.entityName; });
            default:
                return operators.filter(function (action) {
                    /** @type {?} */
     ...
     */ ChangeSetItemFactory = (function () {
         ...
         */
            function (entityName, keys) {
                /** @type {?} */
                var ids = Array.isArray(keys) ? keys : keys ? (([keys])) : [];
    ...
    var SaveEntitiesCancel = (function () {
    ...
    var SaveEntitiesCanceled = (function () {
    ...
    var SaveEntitiesError = (function () {
    ...
    var SaveEntitiesSuccess = (function () {
     ...
     * such as the `DefaultDataService<T>`.
     * @abstract
     */ DefaultDataServiceConfig = (function () {
     ...
     * Used by the `DefaultHttpUrlGenerator`.
     * @abstract
     */ EntityHttpResourceUrls = (function () {
     ...
     * single entity or entity collection resource
     * @abstract
     */ HttpUrlGenerator = (function () {
        function HttpUrlGenerator() {
        }
        return HttpUrlGenerator;
    }());
    var DefaultHttpUrlGenerator = (function () {
        ...
        /** @nocollapse */
        DefaultHttpUrlGenerator.ctorParameters = function () {
            return [
                { type: Pluralizer }
            ];
        };
     ...
     * Assumes a common REST-y web API
     * @template T
     */ DefaultDataService = (function () {
        function DefaultDataService(entityName, http$$1, httpUrlGenerator, config) {
            this.http = http$$1;
         ...
         */
            function (entity$$1) {
                /** @type {?} */
                var entityOrError = entity$$1 || new Error("No \"" + this.entityName + "\" entity to add");
         ...
         */
            function (entity$$1) {
                /** @type {?} */
                var entityOrError = entity$$1 || new Error("No \"" + this.entityName + "\" entity to upsert");
                return this.execute('POST', this.entityUrl, entityOrError);
            };
        /**
         * @param {?} method
     ...
     * Assumes a common REST-y web API
     */
    var DefaultDataServiceFactory = (function () {
        function DefaultDataServiceFactory(http$$1, httpUrlGenerator, config) {
            this.http = http$$1;
            this.httpUrlGenerator = httpUrlGenerator;
            this.config = config;
            config = config || {};
        ...
        /** @nocollapse */
        DefaultDataServiceFactory.ctorParameters = function () {
            return [
     ...
     */
    var EntityDefinitionService = (function () {
        ...
        /** @nocollapse */
        EntityDefinitionService.ctorParameters = function () {
            return [
     ...
     */
    var EntityCacheDataService = (function () {
        function EntityCacheDataService(entityDefinitionService, http$$1, config) {
        ...
        /** @nocollapse */
        EntityCacheDataService.ctorParameters = function () {
            return [
     ...
     */
    var EntityDataService = (function () {
        ...
        /** @nocollapse */
        EntityDataService.ctorParameters = function () {
            return [
     ...
     * Handling of responses from persistence operation
     * @abstract
     */ PersistenceResultHandler = (function () {
     ...
     */
    var DefaultPersistenceResultHandler = (function () {
        ...
        /** @nocollapse */
        DefaultPersistenceResultHandler.ctorParameters = function () {
            return [
                { type: Logger },
     ...
     */
    var CorrelationIdGenerator = (function () {
     ...
     */
    var EntityDispatcherDefaultOptions = (function () {
     ...
     */
    var EntityCacheDispatcher = (function () {
        function EntityCacheDispatcher(correlationIdGenerator, defaultDispatcherOptions, /** Actions scanned by the store after it processed them with reducers. */ scannedActions$, store$$1) {
        ...
        /** @nocollapse */
        EntityCacheDispatcher.ctorParameters = function () {
            return [
     ...
     * All save commands rely on an Ngrx Effect such as `EntityEffects.persist$`.
     * @template T
     */ EntityDispatcherBase = (function () {
        function EntityDispatcherBase(entityName, entityActionFactory, store$$1, selectId, defaultDispatcherOptions, reducedActions$, /** Store selector for the EntityCache */ 
         ...
         * after server reports successful save or the save error.
         */
            function (entity$$1, options) {
                var _this = this;
                options = this.setSaveEntityActionOptions(options, this.defaultDispatcherOptions.optimisticAdd);
                /** @type {?} */
                var action = this.createEntityAction(EntityOp.SAVE_ADD_ONE, entity$$1, options);
            ...
            function (options) {
                ...
                operators.withLatestFrom(this.entityCollection$), operators.map(function (_a) {
                    ...
                    return entities.reduce(function (acc, e) {
                        /** @type {?} */
                        var entity$$1 = collection.entities[_this.selectId(e)];
                        if (entity$$1) {
                            acc.push(entity$$1); // only return an entity found in the collection
                        }
                        return acc;
                    }, /** @type {?} */ ([]));
                }), operators.shareReplay(1));
         ...
         */
            function (key, options) {
                ...
                // as it might be different from the entity returned from the server.
                operators.withLatestFrom(this.entityCollection$), operators.map(function (_a) {
                    var _b = tslib_1.__read(_a, 2), entity$$1 = _b[0], collection = _b[1];
                    return collection.entities[_this.selectId(entity$$1)];
                }), operators.shareReplay(1));
            };
        /**
         ...
         */
            function (entity$$1, options) {
                var _this = this;
                /** @type {?} */
                var update = this.toUpdate(entity$$1);
         ...
         */
            function (entity$$1, options) {
                ...
                /** @type {?} */
                var action = this.createEntityAction(EntityOp.SAVE_UPSERT_ONE, entity$$1, options);
                if (options.isOptimistic) {
                    this.guard.mustBeEntity(action);
                }
                this.dispatch(action);
         ...
         */
            function (entity$$1, options) {
                this.createAndDispatch(EntityOp.ADD_ONE, entity$$1, options);
            };
        /**
         ...
         */
            function (entities, options) {
                ...
                /** @type {?} */
                var updates = entities.map(function (entity$$1) { return _this.toUpdate(entity$$1); });
         ...
         */
            function (entity$$1, options) {
                this.createAndDispatch(EntityOp.UPSERT_ONE, entity$$1, options);
            };
        /**
     ...
     */
    var EntityDispatcherFactory = (function () {
        function EntityDispatcherFactory(entityActionFactory, store$$1, entityDispatcherDefaultOptions, scannedActions$, entityCacheSelector, correlationIdGenerator) {
            this.entityActionFactory = entityActionFactory;
            this.store = store$$1;
        ...
        /** @nocollapse */
        EntityDispatcherFactory.ctorParameters = function () {
            return [
                { type: EntityActionFactory },
                { type: store.Store },
                { type: EntityDispatcherDefaultOptions },
     ...
     * @suppress {checkTypes,extraRequire,uselessCode} checked by tsc
     */
    var EntityCacheEffects = (function () {
        function EntityCacheEffects(actions, dataService, entityActionFactory, logger, /**
             ...
             */
            this.saveEntitiesCancel$ = this.actions.pipe(effects.ofType(EntityCacheAction.SAVE_ENTITIES_CANCEL), operators.filter(function (a) { return a.payload.correlationId != null; }));
            this.saveEntities$ = this.actions.pipe(effects.ofType(EntityCacheAction.SAVE_ENTITIES), operators.mergeMap(function (action) { return _this.saveEntities(action); }));
        }
        /**
         ...
         */
            function (action) {
                ...
                try {
                    ...
                    /** @type {?} */
                    var c = this.saveEntitiesCancel$.pipe(operators.filter(function (a) { return correlationId_1 === a.payload.correlationId; }), operators.map(function (a) { return new SaveEntitiesCanceled(correlationId_1, a.payload.reason, a.payload.tag); }));
                    /** @type {?} */
         ...
         */
            function (action, entityActionFactory) {
                ...
                return function (changeSet) {
                    ...
                    return rxjs.merge(entityNames.map(function (name) { return entityActionFactory.create(name, EntityOp.SET_LOADING, false); }));
                };
            };
        ...
        /** @nocollapse */
        EntityCacheEffects.ctorParameters = function () {
            return [
    ...
    var EntityEffects = (function () {
        function EntityEffects(actions, dataService, entityActionFactory, resultHandler, /**
             ...
             */
            this.cancel$ = this.actions.pipe(ofEntityOp(EntityOp.CANCEL_PERSIST), operators.map(function (action) { return action.payload.correlationId; }), operators.filter(function (id) { return id != null; }));
     ...
     * @template T, S$
     */
    EntityCollectionServiceBase = (function () {
         ...
         */
            function (entity$$1, options) {
                return this.dispatcher.add(entity$$1, options);
            };
        /**
         ...
         */
            function (entity$$1, options) {
                return this.dispatcher.update(entity$$1, options);
            };
        /**
         * Dispatch action to save a new or existing entity to remote storage.
         ...
         */
            function (entity$$1, options) {
                return this.dispatcher.upsert(entity$$1, options);
            };
         ...
         */
            function (entity$$1) {
                this.dispatcher.addOneToCache(entity$$1);
            };
        /**
         * Add multiple new entities directly to the cache.
         * Does not save to remote storage.
         ...
         */
            function (entity$$1) {
                ...
                // pass the Update<T> structure as the payload
                this.dispatcher.updateOneInCache(entity$$1);
            };
        /**
         * Update multiple cached entities directly.
         * Does not update these entities in remote storage.
         ...
         */
            function (entity$$1) {
                this.dispatcher.upsertOneInCache(entity$$1);
            };
        /**
         * Add or update multiple cached entities directly.
         * Does not save to remote storage.
     ...
     * @suppress {checkTypes,extraRequire,uselessCode} checked by tsc
     */
    var EntityCollectionCreator = (function () {
        ...
        /** @nocollapse */
        EntityCollectionCreator.ctorParameters = function () {
            return [
     ...
     */
    var EntitySelectorsFactory = (function () {
         ...
         */
            function (metadataOrName) {
                ...
                /** @type {?} */
                var selectEntities = store.createSelector(selectKeys, selectEntityMap, function (keys, entities) { return keys.map(function (key) { return (entities[key]); }); });
                /** @type {?} */
        ...
        /** @nocollapse */
        EntitySelectorsFactory.ctorParameters = function () {
            return [
     ...
     */
    var EntitySelectors$Factory = (function () {
        function EntitySelectors$Factory(store$$1, actions, selectEntityCache) {
            this.store = store$$1;
            this.actions = actions;
            this.selectEntityCache = selectEntityCache;
            // This service applies to the cache in ngrx/store named `cacheName`
            this.entityCache$ = this.store.select(this.selectEntityCache);
            this.entityActionErrors$ = actions.pipe(operators.filter(function (ea) { return ea.payload && ea.payload.entityOp && ea.payload.entityOp.endsWith(OP_ERROR); }), operators.shareReplay(1));
        }
        /**
        ...
        /** @nocollapse */
        EntitySelectors$Factory.ctorParameters = function () {
            return [
                { type: store.Store },
                { type: effects.Actions },
                { type: undefined, decorators: [{ type: core.Inject, args: [ENTITY_CACHE_SELECTOR_TOKEN,] }] }
     ...
     */
    var EntityCollectionServiceElementsFactory = (function () {
        ...
        /** @nocollapse */
        EntityCollectionServiceElementsFactory.ctorParameters = function () {
            return [
     ...
     */
    var EntityCollectionServiceFactory = (function () {
        ...
        /** @nocollapse */
        EntityCollectionServiceFactory.ctorParameters = function () {
            return [
     ...
     */
    var EntityServicesElements = (function () {
        function EntityServicesElements(entityCollectionServiceFactory, /** Creates EntityDispatchers for entity collections */ 
        /** Creates EntityDispatchers for entity collections */
        entityDispatcherFactory, /** Creates observable EntitySelectors$ for entity collections. */ 
        /** Creates observable EntitySelectors$ for entity collections. */
        entitySelectors$Factory, store$$1) {
        ...
        /** @nocollapse */
        EntityServicesElements.ctorParameters = function () {
            return [
     ...
     * }
     */
    var EntityServicesBase = (function () {
        ...
        /** @nocollapse */
        EntityServicesBase.ctorParameters = function () {
            return [
     ...
     * See EntityChangeTracker docs.
     * @template T
     */ EntityChangeTrackerBase = (function () {
            ...
            function (entities, collection, defaultMergeStrategy, mergeStrategy) {
                ...
                switch (mergeStrategy) {
                    ...
                    case MergeStrategy.OverwriteChanges:
                        ...
                        changeState = entities.reduce(function (chgState, entity$$1) {
                            /** @type {?} */
                            var id = _this.selectId(entity$$1);
                            /** @type {?} */
                    ...
                    case MergeStrategy.PreserveChanges: {
                        ...
                        changeState = entities.reduce(function (chgState, entity$$1) {
                            ...
                            if (change) {
                                ...
                                chgState[id].originalValue = entity$$1;
                            }
                            else {
                                upsertEntities_1.push(entity$$1);
                            }
                            return chgState;
                        }, collection.changeState);
         ...
         */
            function (entities, collection, mergeStrategy) {
                ...
                var didMutate = false;
                /** @type {?} */
                var changeState = entities.reduce(function (chgState, entity$$1) {
                    /** @type {?} */
                    var id = _this.selectId(entity$$1);
                    if (id == null || id === '') {
         ...
         * @return {?}
         */
            function (entity$$1, collection, mergeStrategy) {
                return entity$$1 == null ? collection : this.trackAddMany([entity$$1], collection, mergeStrategy);
            };
        /**
         ...
         */
            function (updates, collection, mergeStrategy) {
                ...
                var changeState = updates.reduce(function (chgState, update) {
                    var id = update.id, entity$$1 = update.changes;
                    if (id == null || id === '') {
         ...
         */
            function (entity$$1, collection, mergeStrategy) {
                return entity$$1 == null ? collection : this.trackUpsertMany([entity$$1], collection, mergeStrategy);
            };
     ...
     * Base implementation of reducer methods for an entity collection.
     * @template T
     */ EntityCollectionReducerMethods = (function () {
         ...
         */
            function (collection, action) {
                if (this.isOptimistic(action)) {
                    /** @type {?} */
                    var entity$$1 = this.guard.mustBeEntity(action);
                    /** @type {?} */
                    var mergeStrategy = this.extractMergeStrategy(action);
                    collection = this.entityChangeTracker.trackAddOne(entity$$1, collection, mergeStrategy);
                    collection = this.adapter.addOne(entity$$1, collection);
                }
                return this.setLoadingTrue(collection);
            };
        /**
         ...
         */
            function (collection, action) {
                ...
                if (this.isOptimistic(action)) {
                    ...
                    collection = this.entityChangeTracker.mergeSaveAdds([entity$$1], collection, mergeStrategy);
                }
                return this.setLoadingFalse(collection);
            };
         ...
         */
            function (collection, action) {
                if (this.isOptimistic(action)) {
                    ...
                    /** @type {?} */
                    var mergeStrategy = this.extractMergeStrategy(action);
                    collection = this.entityChangeTracker.trackUpsertOne(entity$$1, collection, mergeStrategy);
                    collection = this.adapter.upsertOne(entity$$1, collection);
                }
                return this.setLoadingTrue(collection);
            };
        /**
         ...
         */
            function (collection, action) {
                ...
                collection = this.entityChangeTracker.mergeSaveUpserts([entity$$1], collection, mergeStrategy);
                return this.setLoadingFalse(collection);
            };
         ...
         */
            function (collection, action) {
                ...
                var mergeStrategy = this.extractMergeStrategy(action);
                collection = this.entityChangeTracker.trackAddOne(entity$$1, collection, mergeStrategy);
                return this.adapter.addOne(entity$$1, collection);
            };
        /**
         * @param {?} collection
         * @param {?} action
         ...
         */
            function (collection, action) {
                ...
                var mergeStrategy = this.extractMergeStrategy(action);
                collection = this.entityChangeTracker.trackUpsertOne(entity$$1, collection, mergeStrategy);
                return this.adapter.upsertOne(entity$$1, collection);
            };
        /**
         * @param {?} collection
         * @return {?}
     ...
     */
    var EntityCollectionReducerMethodsFactory = (function () {
        ...
        /** @nocollapse */
        EntityCollectionReducerMethodsFactory.ctorParameters = function () {
            return [
                { type: EntityDefinitionService }
            ];
        };
     ...
     */
    var EntityCollectionReducerFactory = (function () {
        ...
        /** @nocollapse */
        EntityCollectionReducerFactory.ctorParameters = function () {
            return [
     ...
     */
    var EntityCollectionReducerRegistry = (function () {
        ...
        /** @nocollapse */
        EntityCollectionReducerRegistry.ctorParameters = function () {
            return [
     ...
     */
    var EntityCacheReducerFactory = (function () {
        ...
        /** @nocollapse */
        EntityCacheReducerFactory.ctorParameters = function () {
            return [
    ...
    var DefaultPluralizer = (function () {
        ...
        /** @nocollapse */
        DefaultPluralizer.ctorParameters = function () {
            return [
    ...
    */
     ...
     */
    var NgrxDataModuleWithoutEffects = (function () {
        ...
        /** @nocollapse */
        NgrxDataModuleWithoutEffects.ctorParameters = function () {
            return [
    ...
    var NgrxDataModule = (function () {
        ...
        /** @nocollapse */
        NgrxDataModule.ctorParameters = function () {
            return [
    ...
    exports.NgrxDataModuleWithoutEffects = NgrxDataModuleWithoutEffects;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,