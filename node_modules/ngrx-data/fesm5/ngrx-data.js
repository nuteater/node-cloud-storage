...
var EntityActionFactory = /** @class */ (function () {
    ...
    function (nameOrPayload, entityOp, data, options) {
        /** @type {?} */
        var payload = typeof nameOrPayload === 'string' ? __assign({}, (options || {}), { entityName: nameOrPayload, entityOp: entityOp, data: data }) : nameOrPayload;
...
ChangeSetItemFactory = /** @class */ (function () {
    ...
    function (entityName, keys) {
        /** @type {?} */
        var ids = Array.isArray(keys) ? keys : keys ? (/** @type {?} */ ([keys])) : [];
 ...
 * @abstract
 */
DefaultDataServiceConfig = /** @class */ (function () {
...
var EntityDefinitionService = /** @class */ (function () {
    function EntityDefinitionService(entityMetadataMaps) {
        ...
        if (entityMetadataMaps) {
            entityMetadataMaps.forEach(function (map$$1) { return _this.registerMetadataMap(map$$1); });
        }
    }
    /**
    ...
    function (metadataMap) {
        ...
        Object.keys(metadataMap || {}).forEach(function (entityName) { return _this.registerMetadata(__assign({ entityName: entityName }, metadataMap[entityName])); });
    };
    /**
    ...
    function (changeSet) {
        ...
        changes = /** @type {?} */ (changes.map(function (item) {
            if (item.op === updateOp && item.entities.length > 0) {
                hasMutated = true;
                return __assign({}, item, { entities: (/** @type {?} */ (item)).entities.map(function (u) { return u.changes; }) });
            }
            else {
                return item;
            }
    ...
    function (changeSet) {
        ...
        changes = /** @type {?} */ (changes.map(function (item) {
            if (item.op === updateOp) {
                ...
                return /** @type {?} */ (__assign({}, item, { entities: item.entities.map(function (u) { return ({ id: selectId_1(u), changes: u }); }) }));
            }
            else {
                return item;
            }
 ...
 * Token to inject a special RxJS Scheduler during marble tests.
  @type {?} */
var ENTITY_EFFECTS_SCHEDULER = new InjectionToken('EntityEffects Scheduler');
...
EntityChangeTrackerBase = /** @class */ (function () {
     ...
     */
    function (collection) {
        return Object.keys(collection.changeState).length === 0 ? collection : __assign({}, collection, { changeState: {} });
    };
    /**
            ...
            case MergeStrategy.PreserveChanges: {
                ...
                changeState = updateResponseData.reduce(function (chgState, update) {
                    ...
                    if (change) {
                        ...
                        /** @type {?} */
                        var newOrigValue = __assign({}, (/** @type {?} */ (oldChangeState.originalValue)), (/** @type {?} */ (update.changes)));
...
EntityCollectionReducerMethods = /** @class */ (function () {
    ...
    function (collection, action) {
        ...
        return collection.changeState === changeState ? collection : __assign({}, collection, { changeState: changeState });
    };
    /**
    ...
    function (collection, action) {
        /** @type {?} */
        var filter$$1 = this.extractData(action);
        return collection.filter === filter$$1 ? collection : __assign({}, collection, { filter: filter$$1 });
    };
    /**
     * @param {?} collection
     * @param {?} action
    ...
    function (collection, action) {
        ...
        return collection.loaded === loaded ? collection : __assign({}, collection, { loaded: loaded });
    };
    /**
     * @param {?} collection
     * @param {?} action
    ...
    function (collection, loading) {
        ...
        return collection.loading === loading ? collection : __assign({}, collection, { loading: loading });
    };
...
var EntityCacheReducerFactory = /** @class */ (function () {
    ...
    function (cache, action) {
        ...
        return action.payload.error || collection === newCollection ? cache : __assign({}, cache, (_a = {}, _a[entityName] = newCollection, _a));
        var _a;
    };
    /**
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,